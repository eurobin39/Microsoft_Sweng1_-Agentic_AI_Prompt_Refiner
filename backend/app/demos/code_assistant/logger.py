"""
Structured Tracing for the code assistant.
...
_AGENT_INSTRUCTIONS = {
    "code_explainer": "Explain what the code does in plain English.",
    "code_refactor": "Rewrite the code to be cleaner and easier to read.",
    "code_documenter": "Add docstrings and comments to the code.",
}
...
class WorkflowTracer:
    """
    Manual trace builder for code assistant runs.
